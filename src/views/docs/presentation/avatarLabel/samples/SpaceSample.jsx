...
const CONTENT = (
  <View gap={10} flex center>
    <AvatarLabel label="Default" text avatarColor="red" round />
    <AvatarLabel label="Custom Gap" text avatarColor="orange" round gap={10} />
    <AvatarLabel label="Inverted" text avatarColor="blue" round invert />
  </View>
)
